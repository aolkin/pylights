# -*- coding: utf-8 -*-
#
# EOL AutoKey documentation build configuration file, created by
...
try:
    ...
    print('\nPlease supply a "PROJECT_VERSION" environment variable to '+
          'build documentation!\n')
    sys.exit(1)
# The full version, including alpha/beta/rc tags.
release = version+os.environ.get("PROJECT_RELEASE","")
...
html_title = "{project} v{release} Documentation".format(**globals())
...
latex_documents = [
  ('index', 'EOLAutoKey.tex', u'EOL AutoKey Documentation',
